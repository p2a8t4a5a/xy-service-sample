package com.fresh.xy.sample.ribbon.core.example;
...
public class FlRibbonClientExample {
    ...
    public static void main(String argv[]) throws Exception {
        //1.加载properties
        ConfigurationManager.loadPropertiesFromResources("com/fresh/xy/sample/ribbon/core/example/ribbon-client-example.properties");
