...
public class FlQueryMapEncoder implements QueryMapEncoder {
    private final Map<Class<?>, FlQueryMapEncoder.ObjectParamMetadata> classToMetadata = new HashMap<Class<?>, FlQueryMapEncoder.ObjectParamMetadata>();
    private final static String DEFAULT_PATTERN = "yyyy-MM-dd HH:mm:ss";

    @Override
    public Map<String, Object> encode(Object object) throws EncodeException {
        try {
            FlQueryMapEncoder.ObjectParamMetadata metadata = getMetadata(object.getClass());
    ...
    private FlQueryMapEncoder.ObjectParamMetadata getMetadata(Class<?> objectType) {
        FlQueryMapEncoder.ObjectParamMetadata metadata = classToMetadata.get(objectType);
        if (metadata == null) {
            metadata = FlQueryMapEncoder.ObjectParamMetadata.parseObjectType(objectType);
    ...
    private static class ObjectParamMetadata {
        ...
        private static FlQueryMapEncoder.ObjectParamMetadata parseObjectType(Class<?> type) {
            ...
            return new FlQueryMapEncoder.ObjectParamMetadata(fields);
        }
    }
